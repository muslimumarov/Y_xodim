...
export const EmpoleAddCivilLegal = () => {
  // ------------------api
  ...
  return (
    <>
      <Breadcrumb
        link={"Fuqaroviy huquqiy shartnoma asosida xodim qo'shish"}
        link1={"Xodimlar"}
        link2={"Fuqaroviy huquqiy shartnoma asosida xodim qo'shish"}
      />
