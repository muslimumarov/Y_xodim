...
export const HikJournalTimeEmployee = () => {
  ...
  const {
    ...
    url: `hik-user/time-report-cadry/all?page=${currentPage}&limit=${pageSize}${
  ...
  return (
    <>
      ...
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="grid grid-cols-5 gap-2 max-md:grid-cols-3 max-sm:grid-cols-1 overflow-x-hidden">
          {/* Familiya */}
          <Input
        ...
        {latecomers && (
          <div className="mt-2 grid grid-cols-5 gap-2 justify-end">
            <div></div>
            <div></div>
            <DatePicker
