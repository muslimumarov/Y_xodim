...
export const EmployeeAcademic = () => {
  ...
  const {
    ...
    url: `employee-academic/find/all`,
  });
  ...
  const deleteConfirm = (id) => {
    mutate({
      url: `employee-academic/delete/${id}`,
      method: "DELETE",
      onSuccess: () => {
        refetch();
  ...
  return (
    <>
      <Breadcrumb
        link={"Xodimlar akademiyasi"}
        link1={"Xodimlar akademiyasi"}
        link2={""}
      />
