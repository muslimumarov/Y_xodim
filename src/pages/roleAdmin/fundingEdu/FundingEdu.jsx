...
export const FundingEdu = () => {
  ...
  return (
    <>
      <Breadcrumb
        link={"Mablag'lashtirish"}
        link1={"Mablag'lashtirish"}
        link2={""}
      />
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        ...
        <Modal
          title="Mablag'lashtirish qo'shish"
          open={openModal}
          onOk={showModal}
            ...
            <div className="w-full">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Mablag'lashtirish nomi"
                    size="large"
