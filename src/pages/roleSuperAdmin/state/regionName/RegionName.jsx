...
export const RegionName = () => {
  ...
  const {
    ...
    url: `region/find/all?page=${currentPage}&limit=10${
  ...
  const {
    ...
    url: `state/find/all?page=1&limit=10000&lang=uz`,
  });
  ...
  return (
    <>
      <Breadcrumb link={"Viloyat"} link1={"Manzil"} link2={"Viloyat"} />
