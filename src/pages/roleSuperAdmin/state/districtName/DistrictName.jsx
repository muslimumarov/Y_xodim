...
export const DistrictName = () => {
  ...
  const {
    ...
    url: `district/find/all?page=${currentPage}&limit=10${
      stateId ? `&region_id=${stateId}` : ""
    }&lang=uz`,
  });
  //   Viloyatni olish
  const {
    data: { data: dataRigion },
  } = useGet({
    url: `region/find/all?page=1&limit=10000&lang=uz`,
  });
  ...
  return (
    <>
      <Breadcrumb
        link={"Tuman(Shahar) qo'shish"}
        link1={"Manzil"}
        link2={"Tuman(Shahar) qo'shish"}
      />
