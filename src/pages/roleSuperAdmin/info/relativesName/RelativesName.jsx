...
export const RelativesName = () => {
  ...
  return (
    <>
      <Breadcrumb
        link={"Qarindosh qo'shish"}
        link1={"Ma'lumotlar"}
        link2={"Qarindosh qo'shish"}
      />
