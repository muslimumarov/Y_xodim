...
export const ReasonsForDismissal = () => {
  ...
  const onSubmit = (form) => {
    if (editId != -1) {
      mutate({
        url: "reasons-for-dismissal/action",
        method: "POST",
        data: {
          action: "edit",
          id: editId,
  ...
  return (
    <>
      <Breadcrumb
        link={"Ishdan bo'shash sabablari"}
        link1={"Ma'lumotlar"}
        link2={"Ishdan bo'shash sabablari"}
      />
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="w-full flex justify-end  mb-6">
          ...
          >
            Ishdan bo'shash sabablari qo'shish
          </button>
        </div>
          ...
          <table className="table w-full min-w-[1100px] border-collapse border-spacing-0 border border-solid border-[var(--borderWhite-color)]">
            <thead className="table-header-group">
              <tr className="text-inherit table-row align-middle outline-0">
                ...
                <th className="tracking-normal leading-[130%] text-[var(--textBlack-color)] text-sm table-cell align-middle border border-solid border-[var(--borderWhite-color)] p-2 text-start border-l-0 border-r-0">
                  Ishdan bo'shash sabablarini nomi
                </th>
        ...
        <Modal
          title="Ishdan bo'shash sabablari qo'shish"
          open={openModal}
          onOk={showModal}
          ...
          >
            <div className="w-full">
              <label className="text-sm font-normal text-[var(--textBlack-color)] px-3 mb-1">
                Ishdan bo'shash sabablari nomi{" "}
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Ishdan bo'shash sabablari nomi"
                    size="large"
