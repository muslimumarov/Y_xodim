...
export const NationalityName = () => {
  ...
  const {
    ...
    url: `nationality/find/all?page=${currentPage}&limit=10&lang=uz`,
  });
  ...
  return (
    <>
      <Breadcrumb link={"Millati"} link1={"Ma'lumotlar"} link2={"Millati"} />
