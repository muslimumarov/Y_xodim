...
export const CategorystaffName = () => {
  ...
  const {
    ...
    url: `category-staff/find/all?page=${currentPage}&limit=10&lang=uz`,
  });
  ...
  const onSubmit = (form) => {
    if (editId != -1) {
      mutate({
        url: "category-staff/update",
        method: "PUT",
        data: {
          id: editId,
          name: form.name,
          color: form?.color ? form?.color : "#121926",
          bg_color: form?.bg_color ? form?.bg_color : "#fff",
        },
        onSuccess: () => {
          refetch();
          handleCancel();
  ...
  return (
    <>
      <Breadcrumb
        link={"Mehnat munosabatlari turi"}
        link1={"Ma'lumotlar"}
        link2={"Mehnat munosabatlari turi"}
      />
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="w-full flex justify-end  mb-6">
          ...
          >
            Mehnat munosabatlari turi qo'shish
          </button>
        </div>
          ...
          <table className="table w-full min-w-[1100px] border-collapse border-spacing-0 border border-solid border-[var(--borderWhite-color)]">
            <thead className="table-header-group">
              <tr className="text-inherit table-row align-middle outline-0">
                ...
                <th className="tracking-normal leading-[130%] text-[var(--textBlack-color)] text-sm table-cell align-middle border border-solid border-[var(--borderWhite-color)] p-2 text-start border-l-0 border-r-0">
                  Mehnat munosabatlari turi nomi
                </th>
        ...
        <Modal
          title="Mehnat munosabatlari turi qo'shish"
          open={openModal}
          onOk={showModal}
            ...
            <div className="w-full">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Mehnat munosabatlari turi nomi"
                    size="large"
