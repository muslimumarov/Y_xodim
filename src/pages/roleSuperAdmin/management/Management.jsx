...
export const Management = () => {
  ...
  const {
    ...
    url: `management/find/all?page=${currentPage}&limit=10`,
  });
  const {
    data: { data: enterprise },
  } = useGet({
    url: "management/enterprise/find-all",
  });
  ...
  return (
    <>
      <Breadcrumb link={"Boshqarma"} link1={"Boshqarma"} link2={""} />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select
                    ...
                    size="large"
                    placeholder="Qaysi tashkilot tarkibida"
                  >
                    {enterprise?.map((e) => (
