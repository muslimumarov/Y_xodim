...
export const HikSynchronization = () => {
  ...
  const {
    ...
    url: `hik-user/find/all?page=${currentPage}&limit=${pageSize}${
  ...
  }, [currentPage, divaceId, enterpriseId, pageSize]);
  ...
  const func3 = (dev, emp) => {
    ...
    //   // console.log("bir", checkboxDevice[dev], checkboxEmployee[emp]);
  ...
  return (
    <>
      <Breadcrumb
        link={"Sinxronizatsiya (HIK)"}
        link1={"Turniket"}
        link2={"Sinxronizatsiya (HIK)"}
      />
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        onClick={() => {
                          navigate(
                            `/admin/tourniquet/hik-device-employee/${e?.id}`
                          );
                        }}
