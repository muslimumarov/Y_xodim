...
export const ArchivesStaffSuper = () => {
  ...
  const {
    ...
    url: `staff-archive/super-admin/find-all-archive?page=${currentPage}&limit=${pageSize}&lang=uz${
  ...
  return (
    <>
      ...
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        ...
        <div className="grid grid-cols-3 gap-2 overflow-x-hidden ease-in duration-500 w-[70%] max-md:w-full max-sm:grid-cols-2">
          {/* Familiya */}
          <Input
