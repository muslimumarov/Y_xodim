...
export const MedicalSummary = () => {
  ...
  return (
    <>
      <Breadcrumb
        link={"Tibbiy ko'rik xulosasi"}
        link1={"Qo'shimcha"}
        link2={"Tibbiy ko'rik xulosasi"}
      />
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="w-full flex justify-end  mb-6">
          ...
          >
            Tibbiy ko'rik xulosasi qo'shish
          </button>
        </div>
        ...
        <Modal
          title="Tibbiy ko'rik xulosasi qo'shish"
          open={openModal}
          onOk={showModal}
            ...
            <div className="w-full">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Tibbiy ko'rik xulosasi nomi"
                    size="large"
