...
export const LaborLeaveDesc = () => {
  ...
  const {
    ...
    url: `labor-leave-item/find/descs`,
  });
  // tatillar
  const {
    data: { data: leave },
  ...
  const updateOrganizations = (item) => {
    seteditId(item?.id);
    reset({
      labor_leave_item_id: item.labor_leave?.id,
  ...
  return (
    <>
      <Breadcrumb
        link={"Ta'til turlariga asos"}
        link1={"Ta'til turlari"}
        link2={"Ta'til turlariga asos"}
      />
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="w-full flex justify-end  mb-6">
          ...
          >
            Ta'til turlariga asos qo'shish
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="tracking-normal leading-[130%] text-[var(--textBlack-color)] text-sm table-cell align-middle border border-solid border-[var(--borderWhite-color)] p-2 text-start border-l-0 border-r-0">
                      <p
                        ...
                        style={{
                          color: e?.labor_leave?.color,
                          backgroundColor: e?.labor_leave?.bg_color,
                        }}
                      >
                        {e?.labor_leave?.title}
                      </p>
        ...
        <Modal
          title="Ta'til turlariga asos qo'shish"
          open={openModal}
          onOk={showModal}
