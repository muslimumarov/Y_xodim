...
export const ExodimAdmin = () => {
  ...
  const {
    ...
    url: `users/find/all?page=${currentPage}&limit=10${
  ...
  const onSubmit = (form) => {
    if (editId != -1) {
      mutate({
        url: "users/update",
        method: "PUT",
        data: { ...form, file_id: imgs?.id, id: editId },
        onSuccess: () => {
          setimgs();
          refetch();
          resInput();
  ...
  return (
    <>
      ...
      <div className="p-6 rounded-lg bg-[var(--bgWhite-color)]">
        <div className="w-full items-center flex justify-between  mb-6 max-sm:flex-col max-sm:justify-center max-sm:items-start">
          <div className="flex items-center justify-start">
            ...
            <div
              ref={inputsRef}
              className="grid grid-cols-1 gap-2 overflow-x-hidden ease-in duration-500"
            >
              {/* Familiya */}
              <Input
                placeholder="F.I.O."
                ...
                render={({ field }) => (
                  ...
                  >
                    <Select.Option value="ROLE_ADMIN">
                      {roleReturnText("ROLE_ADMIN")}
                    </Select.Option>
                    <Select.Option value="ROLE_SUPER_ADMIN">
                      {roleReturnText("ROLE_SUPER_ADMIN")}
                    </Select.Option>
                  </Select>
                )}
              />
